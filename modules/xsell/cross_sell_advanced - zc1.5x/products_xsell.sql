...
#
## The following is used to install the Zen Cart Cross Sell Plus Advanced Sell Combo mapping table and the admin switches for display control in the catalog.
