...
define('HEADER_ALT_TEXT', 'Provider Area Powered by Custom Scriptz');
...
define('PHP_DATE_TIME_FORMAT', '/dm/Y H:i:s'); // this is used for date()
...
// page title
define('TITLE', STORE_NAME . ': PrivateArea');
...
define('HEADER_TITLE_ONLINE_CATALOG', 'Your Online Store');
