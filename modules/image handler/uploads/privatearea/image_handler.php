...
<form class="contrib" action="https://www.paypal.com/cgi-bin/webscr" method="post">
  ...
  <select name="currency_code">
    ...
    <option value="EUR">&acirc;‚&not; (EUR)</option>
    <option value="GBP">&Acirc;&pound; (GBP)</option>
    <option value="CAD">$ (CAD)</option>
    <option value="AUD">$ (AUD)</option>
    <option value="JPY">&Acirc;&yen; (JPY)</option>
  </select>
  </p>
  <p>
    ...
    case 'layout_new':
      ...
      if ($no_images == 1) {
        ...
        $dir = @dir(DIR_FS_CATALOG_IMAGES);
            ...
            $contents[] = array('text' => TEXT_INFO_IMAGE_DIR . zen_draw_pull_down_menu('imgBaseDir', $dir_info, $default_directory));
