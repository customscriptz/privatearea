 ...
 * Breakpoint 150.
 *
 * require('includes/init_includes/init_provider_auth.php');
 *
 */
  $autoLoadConfig[150][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_provider_auth.php');
/**
 * Breakpoint 160.
 * 
 ...
 * Breakpoint 170.
 *
 * require('includes/init_includes/init_provider_history.php');
 *
 */
  $autoLoadConfig[170][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_provider_history.php');
/**
 * Breakpoint 180.
 * 
