...
define('TEXT_MANUFACTURERS_EMAIL', 'Provider Email Address: ');
...
define('TEXT_EMAIL_MESSAGE', "A new password was requested from " . $_SERVER['REMOTE_ADDR']  . ".\n\nYour new login details to " . STORE_NAME . " are as follow:\n\nLogin: %s\nPassword: %s\n\nAfter you have logged in using the new password, you may change it by going to the 'Tools -> My Profile'.");
