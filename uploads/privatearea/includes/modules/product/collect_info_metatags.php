 ...
 * @version $Id: collect_info_metatags.php 3009 2006-02-11 15:41:10Z wilt $
 */
      ...
      <tr>
        <td><table border="3" cellspacing="4" cellpadding="6">
          ...
          <tr>
            ...
            <td class="main">
              <?php echo zen_draw_input_field('metatags_title[' . $languages[$i]['id'] . ']', (isset($metatags_title[$languages[$i]['id']]) ? stripslashes($metatags_title[$languages[$i]['id']]) : zen_get_metatags_title($pInfo->products_id, $languages[$i]['id'])), zen_set_field_length(TABLE_META_TAGS_PRODUCTS_DESCRIPTION, 'metatags_title', '150', false), '', 'onkeypress="return imposeMaxLength(this, '. ($_SESSION['meta_tags_chars'] > 0 ? $_SESSION['meta_tags_chars'] : 1000) .');"'); //,'id="'.'metatags_title' . $languages[$i]['id'] . '"');?>
            </td>
          </tr>
          <tr>
            <td class="main"valign="top"><?php echo TEXT_META_TAGS_KEYWORDS; ?>&nbsp;</td>
            <td class="main">
              <?php echo zen_draw_textarea_field('metatags_keywords[' . $languages[$i]['id'] . ']', 'soft', '100%', '10', (isset($metatags_keywords[$languages[$i]['id']])) ? stripslashes($metatags_keywords[$languages[$i]['id']]) : zen_get_metatags_keywords($pInfo->products_id, $languages[$i]['id']), 'onkeypress="return imposeMaxLength(this, '. ($_SESSION['meta_tags_chars'] > 0 ? $_SESSION['meta_tags_chars'] : 1000) .');"'); //,'id="'.'metatags_keywords' . $languages[$i]['id'] . '"'); ?>
            </td>
          </tr>
          <tr>
            <td class="main"valign="top"><?php echo TEXT_META_TAGS_DESCRIPTION; ?>&nbsp;</td>
            <td class="main">
              <?php echo zen_draw_textarea_field('metatags_description[' . $languages[$i]['id'] . ']', 'soft', '100%', '10', (isset($metatags_description[$languages[$i]['id']])) ? stripslashes($metatags_description[$languages[$i]['id']]) : zen_get_metatags_description($pInfo->products_id, $languages[$i]['id']), 'onkeypress="return imposeMaxLength(this, '. ($_SESSION['meta_tags_chars'] > 0 ? $_SESSION['meta_tags_chars'] : 1000) .');"'); //,'id="'.'metatags_description' . $languages[$i]['id'] . '"'); ?>
            </td>
          </tr>
        </table></td>
      </tr>
