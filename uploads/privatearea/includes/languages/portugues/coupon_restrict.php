...
define('TEXT_MANUFACTURER', 'Designer: ');
...
define('ERROR_CANNOT_EDIT', 'Sorry, you cannot edit a coupon that has been rendeemed. The coupon restrictions are read only.');