 ...
 */
  ...
  if ($action == 'new_product_meta_tags' && $_SESSION['allow_meta_tags'] == "0")
  {
	zen_redirect(zen_href_link('denied.php'));
  }
...
// check if the catalog image directory exists
  ...
  if ($_GET['attributes'] == 'true') $messageStack->add(TEXT_SET_NEW_ATTRIBUTES, 'success'); echo $messageStack->output();
?>
<!doctype html>
...
// WebMakers.com Added: Split Page
        ...
        $contents[] = array('text' => '<br />' . TEXT_HOW_TO_COPY . '<br />' . zen_draw_radio_field('copy_as', 'link', true) . ' ' . TEXT_COPY_AS_LINK);
