 ...
 */
  ...
  if (zen_not_null($action)) {
    switch ($action) {
      ...
      zen_redirect(zen_href_link(FILENAME_CATEGORIES, 'cPath=' . $_GET['cPath'] . ($_SESSION['provider_show_disabled_products'] == 0 ? '' : '&pID=' . $_GET['pID']) . (isset($_GET['page']) ? '&page=' . $_GET['page'] : '')));
      break;
      ...
      <tr>
        <td><table border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="smallText" align="center" width="100" valign="top"><?php echo TEXT_LEGEND_STATUS . '<br />' .  zen_image(DIR_WS_IMAGES . 'icon_green_on.gif', IMAGE_ICON_STATUS_ON) . '&nbsp;&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_red_on.gif', IMAGE_ICON_STATUS_OFF) . '&nbsp;&nbsp;' . zen_image(DIR_WS_IMAGES . 'icon_purple_on.gif', IMAGE_ICON_STATUS_QUEUE); ?></td>
            ...
            <td class="smallText" align="center" width="130" valign="top"><?php echo TEXT_LEGEND_PRODUCTS . '<br />' . zen_image(DIR_WS_IMAGES . 'icon_edit.gif', ICON_EDIT) . ' ' . zen_image(DIR_WS_IMAGES . 'icon_delete.gif', ICON_DELETE) . ' ' . zen_image(DIR_WS_IMAGES . 'icon_copy_to.gif', ICON_COPY_TO); ?></td>
            <td class="smallText" align="center" width="100" valign="top"><?php echo TEXT_LEGEND_IMAGE_HANDLER . '<br />' . zen_image(DIR_WS_IMAGES . 'icon_image_handler.gif', ICON_IMAGE_HANDLER); ?></td>
            <td class="smallText" align="center" width="130" valign="top"><?php echo TEXT_LEGEND_ATTRIBUTES . '<br />' . zen_image(DIR_WS_IMAGES . 'icon_attributes.gif', ICON_ATTRIBUTES) . ' ' . zen_image(DIR_WS_IMAGES . 'icon_attributes_on.gif', ICON_ATTRIBUTES); ?></td>
            <td class="smallText" align="center" width="130" valign="top"><?php echo TEXT_LEGEND_SPECIALS . '<br />' . zen_image(DIR_WS_IMAGES . 'icon_specials_add.gif', ICON_PRODUCTS_ADD_SPECIALS) . ' ' . zen_image(DIR_WS_IMAGES . 'icon_specials_edit.gif', ICON_PRODUCTS_EDIT_SPECIALS); ?></td>
			...
			<td class="smallText" align="center" width="150" valign="top"><?php echo XSELL_PRODUCT . '<br />' . zen_image(DIR_WS_IMAGES . 'icon_xsell.png', XSELL_PRODUCT); ?></td>
          </tr>
        </table></td>
      </tr>
  <tr>
...
//        $category_inputs_string .= '<INPUT type="hidden" name="categories_description[' . $languages[$i]['id']  . ']" ' . 'value=' . "'" . zen_get_category_description($cInfo->categories_id, $languages[$i]['id']) . "'>";
    ...
    break;
    case 'edit_category':
    // echo 'I SEE ' . $_SESSION['html_editor_preference_status_privatearea'];
    // set image delete
