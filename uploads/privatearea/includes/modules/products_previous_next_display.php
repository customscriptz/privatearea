 ...
 * @version $Id: products_previous_next_display.php 3009 2006-02-11 15:41:10Z wilt $
 */
  ...
  <tr>
    <td><table border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <?php } ?>
        <td align="left" class="main"><?php echo zen_draw_form('new_category', $curr_page, '', 'get'); ?>&nbsp;&nbsp;<?php echo zen_draw_pull_down_menu('current_category_id', zen_get_category_tree($provider_category, '', '0', '', true), '', 'onChange="this.form.submit();"'); ?><?php echo zen_draw_hidden_field('products_filter', $_GET['products_filter']); echo zen_hide_session_id(); echo zen_draw_hidden_field('action', 'new_cat'); ?>&nbsp;&nbsp;</form></td>
        <?php if ($counter > 0 ) { ?>
