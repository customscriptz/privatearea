...
define('ERROR_NO_EMAIL_TO_SEND', 'No email address to send the coupon to');
define('TEXT_EMAIL', 'Email to Send the Coupon to:');
define('DEFAULT_SBJ', 'I just wanted to send you this Discount Coupon');
...
define('TEXT_COUPON_ANNOUNCE','I\'m pleased to offer you a Store Coupon');
...
define('ERROR_CANNOT_EDIT', 'Sorry, you cannot edit a coupon that has been rendeemed. If necessary, create a new coupon.');